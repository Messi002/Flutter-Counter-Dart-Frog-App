...
// We immediately add a CounterStarted
// event to the bloc in order to start
//listening for updates to the count as soon the widget is mounted.
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          CounterBloc(counterRepository: context.read<CounterRepository>())
...
class IncrementButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FloatingActionButton(
      ...
      onPressed: isConnected ? () => context.read<CounterBloc>().add(const CounterIncrementPressed()) : null,
